...
export default function ClothingSection() {
  return (
    <section className="min-h-screen flex flex-col lg:flex-row">
      {/* Left Panel */}
      <div className="flex-1 bg-white flex flex-col justify-center items-center p-8 lg:p-16">
        <div className="w-full h-full relative">
          <Image
            ...
            priority
          />
          <h1 className="absolute top-5 left-5 ramillas text-4xl lg:text-6xl font-light text-gray-900 leading-tight mb-8 lg:mb-16">
