...
export default function ClothingSection() {
  return (
    <section className="min-h-screen flex flex-col lg:flex-row">
      {/* Left Panel */}
      <div className="relative bg-[url('/images/Swim.png')] bg-cover bg-center flex-1 md:p-4 lg:p-8 m-10 h-[600px] md:h-[800px] w-full">
      ...
      {/* Right Panel */}
      <div className="flex-1 bg-[#65460a] flex flex-col justify-center items-center p-8 lg:p-16 m-10">
